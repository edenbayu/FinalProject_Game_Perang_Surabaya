...
@export var json_path = "res://DialogSistem/DialogueSistem.json"
...
func _transition():
	match id:
		10:
			trans_text.text = "Sementara itu, di dalam hotel Yamato..."
			is_faded_black = false
			animation_player.play("transition")
			show_transition_text()
		32:
			trans_text.visible_ratio = 0
			trans_text.text = "keluar dari hotel bersama Hariyono"
			is_faded_black = false
			animation_player.play("transition")
			show_transition_text()
